...
function LoginPage() {
  ...
  const handleCodeLogin = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`${API_URL}/auth-code/login`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  return (
    ...
    >
      ...
      >
        <h1 style={{ margin: "0 0 24px", fontSize: 24 }}>Smart Order</h1>
        ...
        <p style={{ textAlign: "center", fontSize: 14, margin: "20px 0 0", color: "#666" }}>
          没有账号？
          <Link to="/register" style={{ color: "#1677ff", textDecoration: "none" }}>
            立即注册
          </Link>
        </p>
      </div>
